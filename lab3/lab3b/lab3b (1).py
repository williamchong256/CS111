...
def Calc_max_block_count(element):
    return element.s_blocks_count

def Calc_first_data_block_num(gp, sblock):
    return int(gp.bg_inode_table + math.ceil(gp.s_inodes_per_group * sblock.s_inode_size / sblock.block_size))
...
def main ():
    ...
    # Calc_max_block_count(superblock_element)
    # Calc_first_data_block_num(group_element, superblock_element)
